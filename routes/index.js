  ...
  async.waterfall([
    ...
    function(token, user, done){
      ...
      var mailOptions = {
        ...
        text: "You are receiving this because you (or someone else) has requested the reset of the password for YelpCamp" + "\n\n" + 
...
router.post("/reset/:token", function(req, res) {
  async.waterfall([
    ...
    function(user, done) {
      ...
      if (err) {
        req.flash("error", "An error when sending you a changed password email.");
        res.redirect("back");
      }
      res.redirect("/campgrounds");
    });
